...
"""decoder: compute SDF from latent vector"""

class Optimizer(object):
    def __init__(self, sdf,configs):
    ...
    def reconstruct_object(self, t_cam_obj, pts, rays, depth, code=None):
        ...
        :return: optimized object pose and shape(latent code), saved as a dict
        """
        ...
        for e in range(self.num_iterations_joint_optim):
            ...
            # update goal: t and latent vector
            t_obj_cam = torch.mm(delta_t, t_obj_cam)
